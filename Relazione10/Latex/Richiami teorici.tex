...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{./figures/img-spezzata}
	\caption{immagine spezzata di una matita parzialmente immersa in un bicchiere d'acqua}
\end{figure}
Il fenomeno della rifrazione è descritto dalla \textbf{Legge di Snell}, secondo cui il raggio incidente, quello rifratto e la normale alla superficie nel punto di incidenza, giacciono nello stesso piano e vale quanto segue:
\begin{equation}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{./figures/rifrazione-1}
	\caption{}
\end{figure}
Si dicono inoltre:
\begin{enumerate}
...
\end{itemize}
Da qui è possibile ricavare agevolmente lo spostamento $x$:
\begin{align}
