...
Mentre la sua incertezza, dalla Legge (17) e ponendo $\vec{x_0}=(d,D_0,D)$, sarà calcolata con la relazione:
...
\begin{equation}
	\Delta \theta_r=\left(\frac{1}{\tan^2(\theta_i)-2b\tan(\theta_i)+b^2+1}\right)\Delta \tan(\theta_i) - \left(\frac{1}{b^2-2b\tan(\theta_i)b+\tan^2(\theta_i)+1}\right)\Delta b=2.1^{\circ}
\end{equation}
